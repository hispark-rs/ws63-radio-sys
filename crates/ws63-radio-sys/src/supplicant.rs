...
unsafe extern "C" {
    ...
    pub fn hisi_wpa_scan_cache_diagnostic_word() -> u32;
    pub fn hisi_wpa_match_diagnostic_word(context: *const Context) -> u32;
    ...
    pub fn hisi_wpa_temporary_reject_recovery_diagnostic_word(context: *const Context) -> u32;
